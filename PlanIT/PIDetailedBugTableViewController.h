...
@protocol PIDetailedBugTableViewControllerDelegate;
@interface PIDetailedBugTableViewController : UITableViewController
...
@protocol PIDetailedBugTableViewControllerDelegate <NSObject>
